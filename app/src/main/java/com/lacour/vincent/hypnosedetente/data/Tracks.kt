...
data class Tracks(
    val samples: List<Sample> = listOf(
        Sample(
            0,
            "Bien dormir",
            "\"Bien dormir\" - Voici un texte composé par Patricia d'Angeli, puis enregistré également " +
        ...
        Sample(
            1,
            "S'endormir",
            "\"S'endormir en auto-hypnose\" - Le premier protocole du livre \"Auto-hypnose pour Débutants\" : comment trouver " +
        ...
        Sample(
            2,
            "Préventif",
            "\"Système immunitaire préventif\" - Cette induction a été conçue, à l'origine, pour aider lors de l'épidémie de grippe H1N1 de l'hiver 2009. " +
        ...
        Sample(
            3,
            "Curatif",
            "\"Système immunitaire curatif\" - Cet accompagnement est curatif. C'est-à-dire que vous n'en avez " +
        ...
        Sample(
            4,
            "Ressourcement",
            "\"Bulle de ressourcement thérapeutique\" - L'idée est de se reconnecter aux forces vitales, puis de plonger dans un espace de ressourcement, afin de renforcer " +
        ...
        Sample(
            ...
            "\"Adaptation aux virus\" - Une expérience d'auto-hypnose pour accélérer en vous l'adaptation à un nouveau virus. " +
        ...
        Sample(
            6,
            "Retrouver le moral",
            "\"Retrouver le moral\" - Après une introduction sautillante, cette séance vous montre ce que vous pouvez " +
        ...
        Sample(
            7,
            "Confiance en soi",
            "\"Confiance en soi\" - Le texte de cette séance est d'Olivier Lockert et il est dit " +
        ...
        Sample(
            8,
            "Estime de soi",
            "\"Estime de soi\" - Voici un accompagnement très complémentaire à celui sur la " +
        ...
        Sample(
            9,
            "Calmer l'anxiété",
            "\"Calmer l'anxiété\" - Patricia d'Angeli vous propose ici un accompagnement à sa " +
        ...
        Sample(
            10,
            "Gérer le stress",
            "\"Gérer le stress\" - Vous serez guidé par la voix de Patricia d'Angeli, " +
        ...
        Sample(
            11,
            "Soigner son passé",
            "\"Soigner son passé\" - Souvent, nos soucis viennent d'un passé douloureux, que l'on peut travailler en thérapie " +
        ...
        Sample(
            12,
            "Intuition",
            "\"Développer son intuition\" - Le domaine de l'intuition est bien plus vaste qu'il n'y parait à première vue. " +
        ...
        Sample(
            13,
            "Réussir sa vie",
            "\"Réussir sa vie\" - Cet accompagnement en Hypnose Humaniste vous propose de travailler sur ce qui bloque éventuellement en vous, " +
        ...
        Sample(
            14,
            "Magie intérieure",
            "\"Magie intérieure\" - Cet accompagnement d'Olivier Lockert vous aidera à activer vos " +
        ...
        Sample(
            15,
            "Bain d'Hypnose",
            "\"Bain d'Hypnose\" - Cet enregistrement vous permet de vous ressourcer, en vous laissant " +
        ...
        Sample(
            16,
            "Auto-Hypnose",
            "\"Auto-Hypnose\" - Cet enregistrement peut vous aider avant " +
        ...
        Sample(
            17,
            "L\'Inconscient",
            "\"Contacter son inconscient\" - Voici les bases, en hypnose, pour contacter et converser avec votre Inconscient : vous apprendrez à établir " +
        ...
        Sample(
            18,
            "Créateur de réalité",
            "\"Créateur de réalité\" - Vous souhaitez en savoir plus sur l'art de créer votre réalité ? Quoi que vous ayez, quoi que " +
        ...
        Sample(
            19,
            "Expansion",
            "\"Expansion de conscience\" - Cette enregistrement est un exemple d'induction hypnotique d'Hypnose Humaniste. L'induction est suivie d'un " +
        ...
        Sample(
            20,
            "Histoire de la vie",
            "\"Histoire de la vie (récit)\" - Olivier Lockert vous présente la structure existentielle, la vaste vision de la " +
        ...
        Sample(
            21,
            "La Conscience",
            "\"La Conscience (récit)\" - Olivier Lockert vous présente la version audio de son article sur \"La Conscience: " +
