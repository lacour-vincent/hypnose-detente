...
data class Tracks(
    val samples: List<Sample> = listOf(
        ...
        Sample(
            0, "Bien dormir", "Voici un texte composé par Patricia d'Angeli, puis enregistré également " +
        ...
        Sample(
            ...
            "Le domaine de l'intuition est bien plus vaste qu'il n'y parait à première vue. " +
                    ...
                    "Patricia d'Angeli et Olivier Lockert. Le fond musical est toujours d'Olivier Lockert.",
