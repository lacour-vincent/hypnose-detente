...
import { onPlayerStateUpdate, pause, play, prepare, release } from "@/store/actions/player";

export type PlayerState = PlayerStateType;

const initialState: PlayerState = { status: PlayerStatus.STATE_IDLE, isPlaying: false, position: 0, duration: 0 };
